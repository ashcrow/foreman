...
ConfigTemplate.without_auditing do
  [
    ...
    { :name => 'Kickstart Atomic', :source => 'kickstart/provision_atomic.erb', :template_kind => kinds[:provision] },
    { :name => 'Kickstart Atomic PXELinux', :source => 'kickstart/PXE_atomic.erb', :template_kind => kinds[:PXELinux] },
    { :name => 'Kickstart Finish', :source => 'kickstart/finish_atomic.erb', :template_kind => kinds[:finish] },
